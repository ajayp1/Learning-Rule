...
#epoch_num = 1
#Load ANN data
with open("/home/paperspace/Desktop/Learning_Rule/"+str(model)+"/epoch_data_919/epoch_"+str(epoch_num)+"/activations_per_category.txt", "rb") as f:
...
a_file = open("./"+str(model)+"/epoch_data_919/"+str(model)+"_brain_area_rsa_epoch"+str(epoch_num)+".pkl", "wb")
pickle.dump(brain_area_rsa, a_file)
a_file.close()
print('Completed RSA for epoch: '+str(epoch_num))